...
describe('getAminoAcidDataForEachBaseOfDna tranlates a', function() {
    ...
    it('1 amino acid long sequence which is subrange of a larger sequence', function() {
        aaData = getAminoAcidDataForEachBaseOfDna('atgtatgagagtagagatagagata', true, {start: 4, end: 6});
        assert.deepEqual(aaData, [{
            aminoAcid: getAA('atg'),
            positionInCodon: 0,
            aminoAcidIndex: 0,
    ...
    it('1 amino acid long sequence which is origin spanning subrange of a larger sequence', function() {
        //                                         012345678
        aaData = getAminoAcidDataForEachBaseOfDna('atgatgatg', true, {start: 6, end: 2});
        assert.deepEqual(aaData, [{
            aminoAcid: getAA('atg'),
            positionInCodon: 0,
            aminoAcidIndex: 0,
