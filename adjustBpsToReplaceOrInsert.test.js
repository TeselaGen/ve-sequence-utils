...
describe('adjustBpsToReplaceOrInsert', function() {
    ...
    it('inserts characters at correct range 0 0', function() {
        adjustBpsToReplaceOrInsert('tttgggaaaccc', 'xxx', {start: 0, end: 0}).should.equal('xxxttgggaaaccc')
    });
    it('inserts characters at correct range 11 11', function() {
        adjustBpsToReplaceOrInsert('tttgggaaaccc', 'xxx', {start: 11, end: 11}).should.equal('tttgggaaaccxxx')
    });
    it('inserts characters at correct range 11 0', function() {
        adjustBpsToReplaceOrInsert('tttgggaaaccc', 'xxx', {start: 11, end: 0}).should.equal('xxxttgggaaacc')
    });
});