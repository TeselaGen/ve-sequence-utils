...
describe("doesEnzymeChopOutsideOfRecognitionSite", function () {
  ...
  it("knows which enzymes chop within the recognition site", function () {
    doesEnzymeChopOutsideOfRecognitionSite(enzymeList["bamhi"]).should.equal(false);
    doesEnzymeChopOutsideOfRecognitionSite(enzymeList["xhoi"]).should.equal(false);
    doesEnzymeChopOutsideOfRecognitionSite(enzymeList["bsmbi"]).should.equal(true);
    doesEnzymeChopOutsideOfRecognitionSite(enzymeList["bsai"]).should.equal(true);
  });
});