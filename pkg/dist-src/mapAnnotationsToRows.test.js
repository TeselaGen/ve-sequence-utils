...
describe("mapAnnotationsToRows", function () {
  it("maps overlapping annotations with joined locations to rows correctly", function () {
    ...
    const bpsPerRow = 5;
    const annotationsToRowsMap = mapAnnotationsToRows(annotations, sequenceLength, bpsPerRow); // console.log(
  ...
  it("maps overlapping annotations to rows correctly", function () {
    ...
    const sequenceLength = 10;
    const bpsPerRow = 5;
    const annotationsToRowsMap = mapAnnotationsToRows(annotations, sequenceLength, bpsPerRow);
