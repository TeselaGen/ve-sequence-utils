export default function condensePairwiseAlignmentDifferences(referenceSeq, alignedSeq) {
  ...
  for (let i = 0; i < referenceSeqSplit.length; i++) {
    if (i < startIndex || i >= endIndex) {
      ...
      i++;
    } else if (referenceSeqSplit[i] === "-" && referenceSeqSplit[i - 1] === "-") {// insertion (NOT first "-" of the insertion)
