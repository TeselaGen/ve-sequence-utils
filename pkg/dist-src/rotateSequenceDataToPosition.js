...
export default function rotateSequenceDataToPosition(sequenceData, caretPosition) {
  const newSequenceData = tidyUpSequenceData(sequenceData); //update the sequence

  newSequenceData.sequence = rotateBpsToPosition(newSequenceData.sequence, caretPosition); //handle the insert
