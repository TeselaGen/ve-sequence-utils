...
describe("index.js", () => {
  it(`should export all functions defined`, done => {
    fs.readdir(__dirname, (err, files) => {
      let passes = true;
      files.forEach(file => {
        if (file.indexOf(".test.js") > -1 || file.indexOf("index.js") > -1 || file.indexOf("prepareRowData_output1.json") > -1) {
          return;
        }
        ...
        if (!funcOrObj) {
          console.info(`Uh oh, it looks like you forgot to export (or explicitly ignore) this file:`, file);
          passes = false;
        }
      });
