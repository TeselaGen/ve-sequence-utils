...
describe("insertSequenceData", function () {
  it("inserts protein and dna characters at correct caret", function () {
    ...
    let caret = 3;
    let postInsertSeq = insertSequenceDataAtPositionOrRange(sequenceToInsert, sequenceToInsertInto, caret);
  ...
  it("inserts protein and dna characters at correct range", function () {
    ...
    let postInsertSeq = insertSequenceDataAtPositionOrRange(sequenceToInsert, sequenceToInsertInto, range);
  ...
  it("inserts characters at correct range", function () {
    ...
    postInsertSeq.sequence.length.should.equal(sequenceToInsertInto.sequence.length + sequenceToInsert.sequence.length - getRangeLength(range));
  });
  ...
  it("inserts characters at correct caret position", function () {
    ...
    let caretPosition = 0;
    let postInsertSeq = insertSequenceDataAtPositionOrRange(sequenceToInsert, sequenceToInsertInto, caretPosition);
    postInsertSeq.sequence.length.should.equal(sequenceToInsertInto.sequence.length + sequenceToInsert.sequence.length);
  });
  it("inserts characters at correct caret position", function () {
    let sequenceToInsert = {
      sequence: "atgagagaga"
    ...
    postInsertSeq.features[0].start.should.equal(sequenceToInsertInto.features[0].start + sequenceToInsert.sequence.length);
  });
});