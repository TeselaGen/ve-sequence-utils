...
import filterSequenceString from "./filterSequenceString.js";
import tidyUpAnnotation from "./tidyUpAnnotation.js";
import filterAminoAcidSequenceString from "./filterAminoAcidSequenceString.js";
import getDegenerateDnaStringFromAaString from "./getDegenerateDnaStringFromAAString.js";
export default function tidyUpSequenceData(pSeqData, options = {}) {
  ...
  if (removeUnwantedChars) {
    if (seqData.isProtein) {
      seqData.proteinSequence = filterAminoAcidSequenceString(seqData.proteinSequence, {
  ...
  annotationTypes.forEach(function (annotationType) {
    ...
    seqData[annotationType] = seqData[annotationType].filter(annotation => {
      return tidyUpAnnotation(annotation, { ...options,
