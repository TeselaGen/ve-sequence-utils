...
import getAA from "./getAminoAcidFromSequenceTriplet.js"; // var collapseOverlapsGeneratedFromRangeComparisonIfPossible = require('./collapseOverlapsGeneratedFromRangeComparisonIfPossible.js');
...
describe("getAminoAcidDataForEachBaseOfDna tranlates a", function () {
  ...
  it("1 amino acid long sequence which is subrange of a larger sequence", function () {
    aaData = getAminoAcidDataForEachBaseOfDna("atgtatgagagtagagatagagata", true, {
      start: 4,
      end: 6
    });
    assert.deepEqual(aaData, [{
